...
<html lang="en">
	...
	<body id="single_project" class="appear-animate child-page">
		...
		<div class="page" id="top">
			...
			<!-- Head Section -->
			<header class="small-section accpp-bg mt-70">
				<div class="relative container align-left">
					<h1 class="hs-line-11 font-alt mb-20 mb-xs-10">Ashuganj 450MW Power Plant</h1>
							...
							<div id="gallery">
								<a href="dist/images/projects/ready-mix-concrete/ashuganj-450mw-ccpp-south/casting-with-long-boom.jpg"
									...
									<img
										...
										alt="Ashuganj 450MW Combined Cycle Power Plant"/>
									<p class="caption">Ashuganj 450MW Combined Cycle Power Plant</p>
									<div class="view">
