		...
		<div class="page" id="top">
					...
					<div class="section-text">
						<div class="row">
							...
							<div class="col-md-4 col-sm-6 mb-sm-50 mb-xs-30">
								...
								ante at ullamcorper pulvinar neque porttitor. Integer
								lectus. Praesent sed nisi eleifend, fermentum orci amet,
								iaculis libero. Donec vel ultricies purus. Nam dictum
								sem, eu aliquam.
							</div>
						</div>
					</div>
			...
			<section class="page-section" id="services">
				<div class="container relative">
					...
					<!-- Nav tabs -->
					<ul
						class="nav nav-tabs tpl-alt-tabs font-alt pt-30 pt-sm-0 pb-30 pb-sm-0"
					>
						<li class="active">
							...
							<div class="section-text">
								<div class="row">
									...
									<div class="col-md-4 col-sm-6 mb-sm-50 mb-xs-30">
										...
										aliquam . Etiam sit amet fringilla lacus.
										Pellentesque suscipit ante at ullamcorper pulvinar
										neque porttitor. Integer lectus. Praesent sed nisi
							...
							<div class="section-text">
								<div class="row">
									<div class="col-md-4 mb-md-40 mb-xs-30">
										<blockquote class="mb-0">
											<p>
												It&nbsp;doesn&rsquo;t matter how many
												times&nbsp;I have to&nbsp;click,
												as&nbsp;long as&nbsp;each click
									...
									<div class="col-md-4 col-sm-6 mb-sm-50 mb-xs-30">
										Cras mi tortor, laoreet id ornare et, accumsan non
										magna. Maecenas vulputate accumsan velit.
										Curabitur a nulla ex. Nam a tincidunt ante. Vitae
										gravida turpis. Vestibulum varius nulla non nulla
										scelerisque tristique.
									</div>
									<div class="col-md-4 col-sm-6 mb-sm-50 mb-xs-30">
										Mauris id viverra augue, eu porttitor diam.
										Praesent faucibus est a interdum elementum. Nam
										varius at ipsum id dignissim. Nam a tincidunt ante
										lorem. Pellentesque suscipit ante at ullamcorper
						...
						<div class="tab-pane fade" id="service-graphic">
							<div class="section-text">
								<div class="row">
									<div class="col-md-4 mb-md-40 mb-xs-30">
										<blockquote class="mb-0">
											<p>
												...
												They&rsquo;re whores. If&nbsp;the one
												you&rsquo;re with isn&rsquo;t doing the job,
									...
									<div class="col-md-4 col-sm-6 mb-sm-50 mb-xs-30">
										Lorem ipsum dolor sit semper amet, consectetur
										adipiscing elit. In maximus ligula metus
										pellentesque mattis. Donec vel ultricies purus.
										Nam dictum sem, ipsum aliquam . Praesent sed nisi
										eleifend, fermentum orci amet, iaculis libero.
									</div>
									<div class="col-md-4 col-sm-6 mb-sm-50 mb-xs-30">
										Pellentesque suscipit ante at ullamcorper pulvinar
										neque porttitor. Integer lectus. Etiam sit amet
										fringilla lacus. Maecenas volutpat, diam enim
										sagittis quam, id porta quam. Sed id&nbsp;dolor
										consectetur fermentum volutpat nibh, accumsan
										purus.
									</div>
								</div>
							</div>
						...
						<div class="tab-pane fade" id="service-development">
							<div class="section-text">
								<div class="row">
									<div class="col-md-4 mb-md-40 mb-xs-30">
										<blockquote class="mb-0">
											<p>
												...
												society depends upon the opportunity for
									...
									<div class="col-md-4 col-sm-6 mb-sm-50 mb-xs-30">
										Fusce hendrerit vitae nunc id gravida. Donec
										euismod quis ante at mattis. Mauris dictum ante
										sit amet enim interdum semper. Vestibulum odio
										justo, faucibus et dictum eu, malesuada nec neque.
										Maecenas volutpat, diam enim sagittis.
									</div>
									<div class="col-md-4 col-sm-6 mb-sm-50 mb-xs-30">
										Pellentesque suscipit ante at ullamcorper pulvinar
										neque porttitor. Sed id dolor consectetur
										fermentum volutpat nibh, accumsan purus. Lorem
										ipsum dolor sit semper amet, consectetur
										adipiscing elit. Inmed maximus ligula metus
										pellentesque.
									</div>
								</div>
							</div>
							...
							<div class="section-text">
								<div class="row">
									<div class="col-md-4 mb-md-40 mb-xs-30">
										<blockquote class="mb-0">
											<p>
												Photography is&nbsp;the simplest thing
												in&nbsp;the world, but
					...
					<div class="align-center">
						<a href="pages-services-1.html" class="section-more font-alt"
							...
							<div class="mt-140 mt-lg-80 mb-140 mb-lg-80">
								<div class="banner-content">
									...
									<div class="banner-decription">
										...
										pulvinar vitae neque et porttitor. Integer non
						...
						<div class="col-sm-3">
							<div class="alt-features-item align-center">
								<div class="alt-features-descr align-left">
									...
									Lorem ipsum dolor sit amet, c-r adipiscing elit. In
						...
						<div class="row">
							<div class="col-md-8 col-md-offset-2">
								<div class="section-text align-center mb-70 mb-xs-40">
									...
									rhoncus, eget tempus sapien ultricies. Donec mollis
									lorem vehicula.
								</div>
							</div>
						</div>
						...
						<li class="work-item">
							<a href="portfolio-single-1.html" class="work-ext-link">
								<div class="work-img">
									<img
										class="work-img"
										src="images/portfolio/projects-13.jpg"
										alt="Work"
									/>
								</div>
						...
						<li class="work-item">
							<a href="portfolio-single-1.html" class="work-ext-link">
								<div class="work-img">
									<img
										class="work-img"
										src="images/portfolio/projects-14.jpg"
										alt="Work"
									/>
								</div>
								<div class="work-intro">
					...
					<div class="row multi-columns-row alt-features-grid">
						...
						<div class="col-sm-6 col-md-4 col-lg-4">
							<div class="alt-features-item align-center">
								...
								<div class="alt-features-descr align-left">
									...
									eleifend, lorem fermentum orci sit amet, iaculis
									libero.
								</div>
							</div>
						</div>
						...
						<div class="col-sm-6 col-md-4 col-lg-4">
							<div class="alt-features-item align-center">
								...
								<div class="alt-features-descr align-left">
									Curabitur iaculis accumsan augue, nec finibus mauris
									pretium eu. Duis placerat ex gravida nibh tristique
									porta. Nulla facilisi. Suspendisse ultricies eros
									blandit.
								</div>
							</div>
						</div>
						...
						<div class="col-sm-6 col-md-4 col-lg-4">
							<div class="alt-features-item align-center">
								...
								<div class="alt-features-descr align-left">
									Cras luctus interdum sodales. Quisque quis odio dui.
						...
						<div class="col-sm-6 col-md-4 col-lg-4">
							<div class="alt-features-item align-center">
								...
								<div class="alt-features-descr align-left">
									...
									Nulla posuere felis id arcu blandit sagittis.
									Eleifender vestibulum purus, sit amet vulputate
									risus.
								</div>
							</div>
						</div>
						...
						<div class="col-sm-6 col-md-4 col-lg-4">
							<div class="alt-features-item align-center">
								...
								<div class="alt-features-descr align-left">
									Pulvinar vitae neque et porttitor. Integer non
									dapibus diam, ac eleifend lectus. Praesent sed nisi
									eleifend, fermentum orci sit amet, iaculis libero
									interdum.
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md-8 col-md-offset-2 align-center">
								...
								<blockquote class="testimonial white">
									<p>
										Phasellus luctus commodo ullamcorper a posuere
										rhoncus commodo elit. Aenean congue, risus
										utaliquam dapibus. Thanks!
									</p>
			...
			<section class="page-section">
				<div class="container relative">
					<h2 class="section-title font-alt align-left mb-70 mb-sm-40">
						...
						<a href="shop-columns-3col.html" class="section-more right"
							>Our Shop <i class="fa fa-angle-right"></i
						></a>
					</h2>
					...
					<div class="row multi-columns-row">
						<!-- Shop Item -->
						<div
							class="col-md-3 col-lg-3 mb-60 mb-xs-40 wow fadeIn"
							data-wow-delay="0.1s"
							data-wow-duration="2s"
						>
							<div class="post-prev-img">
								<a href="shop-single.html"
									><img src="images/shop/shop-prev-1.jpg" alt=""
								/></a>
						...
						>
							<div class="post-prev-img">
								<a href="shop-single.html"
									><img src="images/shop/shop-prev-2.jpg" alt=""
								/></a>
							</div>
							<div class="post-prev-title font-alt align-center">
								<a href="shop-single.html"
									>Only & Sons Pique Polo Shirt</a
								>
							</div>
							<div class="post-prev-text align-center">
								<strong>$28.99</strong>
						...
						>
							<div class="post-prev-img">
								<a href="shop-single.html"
									><img src="images/shop/shop-prev-3.jpg" alt=""
								/></a>
							</div>
							<div class="post-prev-title font-alt align-center">
						...
						>
							<div class="post-prev-img">
								<a href="shop-single.html"
									><img src="images/shop/shop-prev-4.jpg" alt=""
								/></a>
							</div>
							<div class="post-prev-title font-alt align-center">
								<a href="shop-single.html"
									>Polo Shirt With Floral Sleeves</a
								>
							</div>
							<div class="post-prev-text align-center">
								<strong>$85.99</strong>
				...
				<div class="container relative">
					<div class="row">
						<div class="col-md-7 mb-sm-40">
							<!-- Gallery -->
							<div
								class="work-full-media mt-0 white-shadow wow fadeInUp"
							>
								<ul class="clearlist work-full-slider owl-carousel">
									...
									<li>
										<img
											src="images/portfolio/full-project-2.jpg"
											alt=""
										/>
									</li>
								</ul>
						...
						<div class="col-md-5 col-lg-4 col-lg-offset-1">
							...
							<div class="text">
								...
								<p>
									Phasellus facilisis mauris vel velit molestie
									pellentesque. Donec rutrum, tortor ut elementum
									venenatis, purus magna bibendum nisl, ut accumsan
									ipsum erat eu sapien.
								</p>

								<div class="mt-40">
									<a
										href="http://themeforest.net/user/theme-guru/portfolio"
										class="btn btn-mod btn-border btn-round btn-medium"
										target="_blank"
										>Buy Now</a
									>
								</div>
						...
						<div class="col-md-7 col-lg-offset-1">
							...
							>
								<ul class="clearlist work-full-slider owl-carousel">
									...
									<li>
										<img
											src="images/portfolio/full-project-4.jpg"
											alt=""
										/>
									</li>
								</ul>
			...
			<!-- Section -->
			<section
				class="page-section bg-dark-alfa-70 bg-scroll"
				data-background="images/full-width-images/section-bg-16.jpg"
			>
				<div class="container relative">
					<!-- Features Grid -->
							...
							<div class="col-md-8 col-md-offset-2">
								...
								<div class="mb-20">
									<input
										...
										class="newsletter-field form-control input-md round mb-xs-10"
										type="email"
										pattern=".{5,100}"
										required
									/>
								...
								<div class="form-tip">
									<i class="fa fa-info-circle"></i> Please trust us, we
			...
			<section class="small-section bg-dark">
				<div class="container relative">
					<div class="align-center">
						...
						<div>
							<a href="" class="btn btn-mod btn-w btn-medium btn-round"
								>Lets tallk</a
							>
						</div>
					</div>
