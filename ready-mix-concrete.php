...
<head>
	...
	<meta name="description"
		content="Ready-mix Concrete refers to concrete that is made specifically for a customer's construction project and delivered to them as a single product on site." />
	...
	<meta property="og:description"
		content="Ready-mix Concrete refers to concrete that is made specifically for a customer's construction project and delivered to them as a single product on site." />
	<meta property="og:url" content="https://nextspaces.net/ready-mix-concrete.php" />
					...
					<div class="tab-pane fade in active" id="completed">
						<div class="feature-cards">
							...
							<a href="./maitree-power-plant-package-bc.php" class="card">
								<figure class="figure">
									<img class="img" src="dist/images/projects/ready-mix-concrete/maitree-power-plant/cover.jpg"
