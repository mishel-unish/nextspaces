		...
		<div class="page" id="top">
			...
			<header class="small-section header-container bg-gray-lighter mt-70">
				<div class="relative container align-left">
					<h1 class="hs-line-11 font-alt mb-20 mb-xs-0">Acknowledgement</h1>
					<div class="mod-breadcrumbs font-alt">
						<a href="index.php">Home</a> / <span>Acknowledgement</span>
					</div>
				</div>
			</header>
			...
			<main>
				<div class="container">
					<?php include './legal_compliance/acknowledgement.html'; ?>
				</div>
			</main>
