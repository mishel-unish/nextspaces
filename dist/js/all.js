	...
	(function ($) {
		...
		function syncPosition(el) {
			...
			$(".fullwidth-slideshow-pager")
				...
				.addClass("synced");
			if (
				$(".fullwidth-slideshow-pager").data("owlCarousel") !== undefined
			) {
				center(current);
			}
		}
...
(function() {
	if (document.getElementById("contact_form_trigger")) {
		document.getElementById("contact_form_trigger").addEventListener("click", (e) => {
			contactFormWrapper = document.getElementById("contact_form_wrapper");
			if (contactFormWrapper.offsetHeight == 0) {
				let actualHeight = contactFormWrapper.querySelector(".row").offsetHeight;
				contactFormWrapper.style.maxHeight = `${actualHeight}px`;

				document.querySelector("#contact_form_trigger i").style.transform = "rotate(90deg)";
			}
		});
	}
})();
